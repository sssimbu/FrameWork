...
<html>
<head>
<title>TextMining | File Search</title>
					  ...
					  <h2>Text Mining File Properties List</h2>
						...
						<thead>
						  <tr>
							...
							<th>File Id</th>
							<th>Topic</th>
							<th>User Search Word</th>
							<th>System Search Word</th>
							<th>Matching Word</th>
							<th>Line Number</th>
							<th>Page Number</th>
							<th>Synonyms</th>
							<th>Removed Synonyms</th>
							<th>Negation</th>
							<th>Start Time</th>
							<th>End Time</th>
							</tr>
						...
						<c:forEach items="${FileSearchview}" var="user">
                <tr>
                    ...
                    <td><c:out value="${user.user_search_word}" /></td>
                    <td><c:out value="${user.system_search_word}" /></td>
                    <td><c:out value="${user.matching_word}" /></td>
                    <td><c:out value="${user.line_number}" /></td>
                    <td><c:out value="${user.page_number}" /></td>
                     <td><c:out value="${user.synonyms}" /></td>
                     <td><c:out value="${user.removed_synonyms}" /></td>
                      <td><c:out value="${user.negation}" /></td>
