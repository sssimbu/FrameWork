...
<html>
<head>
<title>TextMining | File Properties</title>
...
<!--header end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.jsp">Home</a><i class="fa fa-angle-right" ></i><a href="#" >File Properties</a></li>
            </ol>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Text Mining File Properties List</h2>
						...
						<c:forEach items="${FilePropview}" var="user">
                <tr>
                    <td><c:out value="${user.file_id}" /></td>
                    <td><c:out value="${user.file_path}" /></td>
                    <td><c:out value="${user.file_name}" /></td>
                    <td> <c:out value="${user.customer_name}" /> </td>
                    <td><c:out value="${user.customer_id}" /></td>
                    <td><c:out value="${user.document_type}" /></td>
                    <td><c:out value="${user.reference_number}" /></td>
                    <td><c:out value="${user.branch_id}" /></td>
                    <td><c:out value="${user.date}" /></td>
                    <td><c:out value="${user.time}" /></td>
                    <td><c:out value="${user.password_protected}" /></td>
                    <td><c:out value="${user.read_status}" /></td>
                    <td><c:out value="${user.highlighting_status}" /></td>
                    <td><c:out value="${user.file_type}" /></td>
                    <td><c:out value="${user.file_upload_time}" /></td>
